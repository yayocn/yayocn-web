export const ricenoodle = [
  {
    title: '开始 <small class="inline-block"><code>Start</code></small>',
  ...
  {
    title: '样式增强 <small class="inline-block"><code>Improve</code></small>',
    ...
    children: [
      {
        title: '代码块 <small class="inline-block"><code>Code</code></small>',
      ...
      {
        title: '元素增强 <small class="inline-block"><code>Element</code></small>',
      ...
      {
        title: '图片 <small class="inline-block"><code>Image</code></small>',
  ...
  {
    title: '实用工具 <small class="inline-block"><code>Utilities</code></small>',
    ...
    children: [
      {
        title: '背景 <small class="inline-block"><code>Background</code></small>',
      ...
      {
        title: '边框 <small class="inline-block"><code>Border</code></small>',
      ...
      {
        title: '关闭图标 <small class="inline-block"><code>Close icon</code></small>',
      ...
      {
        title: '弹性布局 <small class="inline-block"><code>Flex</code></small>',
      ...
      {
        title: '浮动 <small class="inline-block"><code>Float</code></small>',
      ...
      {
        title: '字体 <small class="inline-block"><code>Font</code></small>',
      ...
      {
        title: '定位 <small class="inline-block"><code>Position</code></small>',
        info: '使用定位类快速配置元素的位置。',
        icon: '',
        key: 'position',
      ...
      {
        title: '阴影 <small class="inline-block"><code>Shadow</code></small>',
      ...
      {
        title: '尺寸 <small class="inline-block"><code>Size</code></small>',
      ...
      {
        title: '间距 <small class="inline-block"><code>Space</code></small>',
      ...
      {
        title: '文本 <small class="inline-block"><code>Text</code></small>',
      ...
      {
        title: '视图 <small class="inline-block"><code>View</code></small>',
  ...
  {
    title: '组件 <small class="inline-block"><code>Components</code></small>',
    ...
    children: [
      {
        title: '警告框 <small class="inline-block"><code>Alert</code></small>',
      ...
      {
        title: '便签 <small class="inline-block"><code>Badge</code></small>',
      ...
      {
        title: '面包屑导航 <small class="inline-block"><code>Breadcrumb</code></small>',
      ...
      {
        title: '按钮 <small class="inline-block"><code>Button</code></small>',
      ...
      {
        title: '按钮组 <small class="inline-block"><code>Button group</code></small>',
      ...
      {
        title: '卡片 <small class="inline-block"><code>Card</code></small>',
      ...
      {
        title: '轮播图 <small class="inline-block"><code>Carousel</code></small>',
      ...
      {
        title: '折叠 <small class="inline-block"><code>Collapse</code></small>',
      ...
      {
        title: '分割线 <small class="inline-block"><code>Divider</code></small>',
      ...
      {
        title: '圆点 <small class="inline-block"><code>Dot</code></small>',
      ...
      {
        title: '下拉菜单 <small class="inline-block"><code>Dropdown</code></small>',
      ...
      {
        title: '精灵 <small class="inline-block"><code>Elf</code></small>',
      ...
      {
        title: '表单 <small class="inline-block"><code>Form</code></small>',
      ...
      {
        title: '栅格系统 <small class="inline-block"><code>Grid</code></small>',
      ...
      {
        title: '输入框组 <small class="inline-block"><code>Input group</code></small>',
      ...
      {
        title: '巨幕 <small class="inline-block"><code>Jumbotron</code></small>',
      ...
      {
        title: '列表组 <small class="inline-block"><code>List group</code></small>',
      ...
      {
        title: '加载 <small class="inline-block"><code>Loader</code></small>',
      ...
      {
        title: '标记 <small class="inline-block"><code>Mark</code></small>',
      ...
      {
        title: '媒体对象 <small class="inline-block"><code>Media</code></small>',
      ...
      {
        title: '模态框 <small class="inline-block"><code>Modal</code></small>',
      ...
      {
        title: '导航 <small class="inline-block"><code>Nav</code></small>',
      ...
      {
        title: '导航条 <small class="inline-block"><code>Navbar</code></small>',
      ...
      {
        title: '分页 <small class="inline-block"><code>Pagination</code></small>',
        info: '对多条数据进行分页。',
        icon: '',
        key: 'pagination',
      ...
      {
        title: '弹出框 <small class="inline-block"><code>Popover</code></small>',
        info: '为任意元素添加一小块浮层。',
        icon: '',
        key: 'popover',
      ...
      {
        title: '进度条 <small class="inline-block"><code>Progress</code></small>',
      ...
      {
        title: '滚动监听 <small class="inline-block"><code>Scrollspy</code></small>',
      ...
      {
        title: '表格 <small class="inline-block"><code>Table</code></small>',
        info: '表格适用于数据的展示。',
        icon: '',
        key: 'table',
      ...
      {
        title: '提示框 <small class="inline-block"><code>Tooltip</code></small>',
