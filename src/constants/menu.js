export const ricenoodle = [
  ...
  },
  {
    ...
    children: [
      {
        title: '代码块 <small><code>Code</code></small>',
      ...
      {
        title: '元素增强 <small><code>Element</code></small>',
      ...
      {
        title: '图片 <small><code>Image</code></small>',
  ...
  {
    title: '实用工具 <small><code>Utilities</code></small>',
    ...
    children: [
      {
        title: '背景 <small><code>Background</code></small>',
      ...
      {
        title: '边框 <small><code>Border</code></small>',
      ...
      {
        title: '关闭图标 <small><code>Close icon</code></small>',
      ...
      {
        title: '弹性布局 <small><code>Flex</code></small>',
      ...
      {
        title: '浮动 <small><code>Float</code></small>',
      ...
      {
        title: '字体 <small><code>Font</code></small>',
      ...
      {
        title: '定位 <small><code>Position</code></small>',
        info: '使用定位类快速配置元素的位置。',
        icon: '',
        key: 'position',
      ...
      {
        title: '阴影 <small><code>Shadow</code></small>',
      ...
      {
        title: '尺寸 <small><code>Size</code></small>',
      ...
      {
        title: '间距 <small><code>Space</code></small>',
      ...
      {
        title: '文本 <small><code>Text</code></small>',
      ...
      {
        title: '视图 <small><code>View</code></small>',
  ...
  {
    title: '组件 <small><code>Components</code></small>',
    ...
    children: [
      {
        title: '警告框 <small><code>Alert</code></small>',
      ...
      {
        title: '便签 <small><code>Badge</code></small>',
      ...
      {
        title: '面包屑导航 <small><code>Breadcrumb</code></small>',
      ...
      {
        title: '按钮 <small><code>Button</code></small>',
      ...
      {
        title: '按钮组 <small><code>Button group</code></small>',
      ...
      {
        title: '卡片 <small><code>Card</code></small>',
      ...
      {
        title: '轮播图 <small><code>Carousel</code></small>',
      ...
      {
        title: '折叠 <small><code>Collapse</code></small>',
      ...
      {
        title: '分割线 <small><code>Divider</code></small>',
      ...
      {
        title: '圆点 <small><code>Dot</code></small>',
      ...
      {
        title: '下拉菜单 <small><code>Dropdown</code></small>',
      ...
      {
        title: '精灵 <small><code>Elf</code></small>',
      ...
      {
        title: '表单 <small><code>Form</code></small>',
      ...
      {
        title: '栅格系统 <small><code>Grid</code></small>',
      ...
      {
        title: '输入框组 <small><code>Input group</code></small>',
      ...
      {
        title: '巨幕 <small><code>Jumbotron</code></small>',
      ...
      {
        title: '列表组 <small><code>List group</code></small>',
      ...
      {
        title: '加载 <small><code>Loader</code></small>',
      ...
      {
        title: '标记 <small><code>Mark</code></small>',
      ...
      {
        title: '媒体对象 <small><code>Media</code></small>',
      ...
      {
        title: '模态框 <small><code>Modal</code></small>',
      ...
      {
        title: '导航 <small><code>Nav</code></small>',
      ...
      {
        title: '导航条 <small><code>Navbar</code></small>',
      ...
      {
        title: '分页 <small><code>Pagination</code></small>',
        info: '对多条数据进行分页。',
        icon: '',
        key: 'pagination',
      ...
      {
        title: '弹出框 <small><code>Popover</code></small>',
        info: '为任意元素添加一小块浮层。',
        icon: '',
        key: 'popover',
      ...
      {
        title: '进度条 <small><code>Progress</code></small>',
      ...
      {
        title: '滚动监听 <small><code>Scrollspy</code></small>',
      ...
      {
        title: '表格 <small><code>Table</code></small>',
        info: '表格适用于数据的展示。',
        icon: '',
        key: 'table',
      ...
      {
        title: '提示框 <small><code>Tooltip</code></small>',
